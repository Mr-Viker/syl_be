...
class SmsService {
  ...
  public static function getAcsClient() {
      ...
      $accessKeyId = lsConfig::get('sms_key'); // AccessKeyId

      $accessKeySecret = lsConfig::get('sms_secret'); // AccessKeySecret
  ...
  public static function sendSms($phone, $tempCode = '', $signName = '') {
      ...
      $signName = !empty($signName) ? $signName : lsConfig::get('sms_sign_name');
      $request->setSignName($signName);

      // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
      $tempCode = !empty($tempCode) ? $tempCode : lsConfig::get('sms_temp_code');
